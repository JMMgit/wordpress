...
<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand font-weight-bold" href="<?php echo home_url(); ?>"> <img class="logo rounded" src="<?php bloginfo('template_url'); ?>/img/logo.png" alt=""> RentAcar</a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link" href="<?php echo home_url(); ?>/?page_id=22">Cars</a></li>
