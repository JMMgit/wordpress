...
<main>
    ...
    <section class="container border rounded mt-5">
        <section class="row">
            <div class="col text-center">
                <h2 class="banner font-weight-light text-secondary m-5">HOW IT WORKS</h2>
            </div>
        </section>
    ...
    <section class="container border rounded mt-5">
        <section class="row">
            <div class="col text-center">
                <h2 class="banner text-secondary m-5 font-weight-light">WHY CHOOSE US?</h2>
            </div>
        </section>
